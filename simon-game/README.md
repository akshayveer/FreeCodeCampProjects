# Build a Simon Game
click [here](https://www.freecodecamp.com/challenges/build-a-simon-game) to view the challenge
...
click [here](https://codepen.io/akshayveer/pen/PjQZgj) to view on codepen
